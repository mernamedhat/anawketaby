...
import 'package:anawketaby/providers_models/screens/admin_screens/requests_screens/admin_requests_screen_provider.dart';
import 'package:anawketaby/ui/widgets/empty_list_loader.dart';
import 'package:anawketaby/ui/widgets/empty_list_text.dart';
import 'package:anawketaby/ui/widgets/request_vertical_tile.dart';
...
class AdminRequestsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => AdminRequestsScreenProvider(),
      child: Consumer<AdminRequestsScreenProvider>(builder: (_, provider, __) {
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: StreamBuilder<QuerySnapshot>(
                        stream:
                            RequestsManagement.instance.getPendingRequests(),
                          ...
                          if (!snapshot.hasData)
                            ...
                            return ListView.separated(
                                ...
                                itemBuilder: (_, index) {
                                  ...
                                  return RequestVerticalTile(request: request);
                                });
                          }
                        },
                      ),
