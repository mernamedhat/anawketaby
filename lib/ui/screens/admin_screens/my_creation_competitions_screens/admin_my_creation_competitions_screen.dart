...
import 'package:anawketaby/providers_models/screens/admin_screens/my_creation_competitions_screens/admin_my_creation_competitions_screen_provider.dart';
...
class AdminMyCreationCompetitionsScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => AdminMyCreationCompetitionsScreenProvider(),
      child: Consumer<AdminMyCreationCompetitionsScreenProvider>(
                    ...
                    child: Container(
                      ...
                      child: StreamBuilder<QuerySnapshot>(
                        stream: CompetitionManagement.instance
                            .getMyCreationCompetitions(provider.appUser!),
