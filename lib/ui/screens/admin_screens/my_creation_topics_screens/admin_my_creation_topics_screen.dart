...
import 'package:anawketaby/providers_models/screens/admin_screens/my_creation_topics_screens/admin_my_creation_topics_screen_provider.dart';
...
class AdminMyCreationTopicsScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => AdminMyCreationTopicsScreenProvider(),
      child: Consumer<AdminMyCreationTopicsScreenProvider>(
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                        stream: TopicsManagement.instance
                            .getMyCreationTopics(provider.appUser!),
