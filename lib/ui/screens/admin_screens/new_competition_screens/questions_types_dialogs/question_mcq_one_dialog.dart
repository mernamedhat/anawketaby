...
class QuestionMCQOneDialog extends StatefulWidget {
  final Competition competition;
  final CompetitionQuestion? competitionQuestion;

  const QuestionMCQOneDialog(
      {Key? key, required this.competition, this.competitionQuestion})
      : super(key: key);

  @override
  _QuestionMCQOneDialogState createState() => _QuestionMCQOneDialogState();
}

class _QuestionMCQOneDialogState extends State<QuestionMCQOneDialog> {
  ...
  _addQuestion() {
    ...
    CompetitionQuestion competitionQuestion = CompetitionQuestion(
      questionType: QuestionTypes.mcq_one,
