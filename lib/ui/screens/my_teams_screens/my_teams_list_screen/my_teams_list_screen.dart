...
import 'package:anawketaby/providers_models/screens/my_teams_screens/my_teams_list_screen/my_teams_list_screen_provider.dart';
...
class MyTeamsListScreen extends StatelessWidget {
  const MyTeamsListScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => MyTeamsListScreenProvider(),
      child: Consumer<MyTeamsListScreenProvider>(builder: (_, provider, __) {
                    ...
                    child: AppBar(
                      ...
                      actions: [
                          TextButton(
                            ...
                            onPressed: provider.createNewTeam,
                          ),
                      ],
                    ),
                  ),
                  Expanded(
                    child: Container(
                      ...
                      child: StreamBuilder<QuerySnapshot>(
                        stream: TeamsManagement.instance
                            .getMyTeams(provider.appUser!),
                            ...
                            if (snapshot.data!.docs.isEmpty)
                              ...
                              return ListView.separated(
                                  ...
                                  itemBuilder: (_, index) {
                                    ...
                                    return TeamVerticalTile(team: team);
                                  });
                            }
                          }
                        },
