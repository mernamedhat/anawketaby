import 'package:anawketaby/providers_models/screens/auth_screens/log_in_screen_provider.dart';
...
class LogInScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Consumer<LogInScreenProvider>(builder: (_, provider, __) {
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(
                                    height:
                                        ResponsiveSize.getWidth(context, 0.06)),
                                Text(
                                  "كلمة السر",
                                  style: TextStyle(
                                    color: AppStyles.TEXT_PRIMARY_COLOR,
