...
class QuestionJoinItem extends StatefulWidget {
  final int? questionNo;
  final CompetitionQuestion question;

  const QuestionJoinItem(
      {Key? key, required this.questionNo, required this.question})
      : super(key: key);

  @override
  _QuestionJoinItemState createState() => _QuestionJoinItemState();
}

class _QuestionJoinItemState extends State<QuestionJoinItem> {
          ...
          RoundedContainer(
            ...
            child: AutoSizeText(
              ...
              style: TextStyle(
                ...
                color: AppStyles.SELECTION_COLOR_DARK,
              ),
            ),
          ),
          SizedBox(height: scaleHeight(8.0)),
